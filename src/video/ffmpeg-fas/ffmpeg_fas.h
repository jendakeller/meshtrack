...
__extern int              fas_get_width  (fas_context_ref_type context);
__extern int              fas_get_height  (fas_context_ref_type context);

__extern fas_error_type   fas_get_frame  (fas_context_ref_type context, fas_raw_image_type *image_ptr);
__extern fas_error_type   fas_get_frame2 (fas_context_ref_type context, void* data);
